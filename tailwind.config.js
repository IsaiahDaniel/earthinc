	...
	theme: {
		extend: {
			backgroundImage: {
				...
				roadmapHeroImg: "url('/imgs/deskHero.svg')",
				mobileRoadmapHeroImg: "url('/imgs/mobileHero.svg')",
				roadmapBgImg: "url('/imgs/roadmap-bg-img.svg')",
				mobileRoadmapBgImg: "url('/imgs/mobile-roadmap-bg.svg')",
				teamImg1:
					"linear-gradient(139.87deg, rgba(171, 84, 253, 0) -2.71%, rgba(234, 110, 231, 0.25) 57.18%, #7D2AE7 94.74%), url('/imgs/liz.svg')",
			},
		},
	},
	plugins: [],
