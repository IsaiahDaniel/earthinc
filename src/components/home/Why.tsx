    ...
    <div className="mt-96 lg:my-10">
      ...
      >
        <div className="flex flex-col leading-none w-full lg:w-[60%]">
          ...
          <h1 className="text-[32px] lg:text-6xl font-medium self-end mr-12 lg:mr-32">
            an Earthling?
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 my-20">
          {reasons.map((reason, index) => (
            <div
              ...
              style={{
                background:
                  "linear-gradient(#EA6EE7 100%, #FD68E3 100%, #B66FFA 100%, #7668FD 100%, #7D2AE7 100% )",
              }}
            >
              <div
              ...
              >
                ...
                <p className='font-["Roboto"] lg:text-2xl lg:font-thin'>{reason.description}</p>
              </div>
            </div>
          ))}
        </div>
