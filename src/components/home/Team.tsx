...
import ValueImgTwo from "../../assets/home/art_card_1.png";
import ValueImgThree from "../../assets/home/art_card_1.png";
  ...
  return (
    <div className="w-full md:w-[80%] mx-auto my-20">
      <div className="flex flex-col leading-none w-[80%] md:w-[60%] mx-auto">
        ...
        <h1 className="text-[32px] lg:text-6xl font-medium self-end mr-36 lg:mr-72">
          team
        </h1>
