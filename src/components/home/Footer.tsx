...
const Footer = (props: Props) => {
	return (
		<div
			className={`flex flex-col relative pt-36 md:pt-48 text-[#fff] bg-mobileFooterBgImg lg:bg-footerBgImg h-[966px] md:h-[1366px] bg-cover bg-no-repeat w-full px-5 lg:px-10`}>
			<div className="w-[90%] md:my-20 mx-auto">
				<div className="flex flex-col leading-none w-full lg:w-[60%]">
					...
					<p className='lg:ml-16 text-xs lg:text-lg font-["Roboto"] mt-4'>
						Sign up now to receive exclusive updates, artist features, exciting events, and special offers straight to your
						inbox.
					</p>
				</div>
