...
const Faq = (props: Props) => {
	...
	return (
		<div className="w-[90%] md:w-[80%] mx-auto my-20 relative" id="faq">
			...
			<div className="w-full md:w-[90%] mx-auto">
				{faq.map((item, i) => (
					<Accordion
						...
						<AccordionBody className="text-sm md:text-base px-4 py-4 md:px-12 md:py-8">{item.answer}</AccordionBody>
					</Accordion>
				))}
			</div>
