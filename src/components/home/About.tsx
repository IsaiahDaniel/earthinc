...
const About = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col items-center bg-[#FAF9FF] px-4 lg:px-20 2xl:px-28 py-10 text-[#1E0734] gap-8 font-["Poppins"] rounded-xl'>
        <p className="text-[28px] lg:text-[80px] font-thin	 leading-none">
        ...
        <p className="lg:text-2xl text-justify tracking-[0.055em]">
          EARTH is the World of Art that Loves, Shares and Expresses Art in its Authenticity. You
          probably got that much from the heading, but let’s paint a picture together shall we?
        </p>

        <p className="lg:text-2xl text-justify tracking-[0.055em]">
          Imagine a world where the artist isn’t blocked from creating by the lack of a brush, maybe
          some paint or even a room filled with adoring fans waiting for his creative ingenuity to
          bring colour to their lives. Yes! That world. That world is EARTH.
        </p>

        <p className="lg:text-2xl text-justify tracking-[0.055em]">
          We believe the Art World is a place for EVERYONE. That’s why we use technology to create a
          safe and stress-free environment for the artist to sell his work commission free and for
          buyers to find art pieces that would bring smiles to their faces, warmth to their hearts
          and stories to their children.
        </p>
        <p className="lg:text-2xl text-justify tracking-[0.055em]">
          And artists who feel like they aren’t seen? We help them find their place in the
          limelight, making sure that they find the right audience…or the right audience finds them,
          putting them in a space where their art can speak freely and be heard. Any artist can
          become seen by the world because we put the spotlight on you.
        </p>

        <p className="lg:text-2xl text-justify tracking-[0.055em]">
          So take this giant leap for Art kind by clicking the button below to join our discord
          community and find your place on EARTH.
        </p>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center w-full lg:w-[80%] lg:h-[370px] mx-auto mt-10 lg:mt-28">
        ...
        <div className="bg-[#B66FFA] text-white gap-4 flex flex-col text-center lg:h-full lg:text-left px-10 py-6 lg:pr-28 lg:pl-10 lg:w-[670px]">
          ...
          <p>
            Experience our captivating video series, 'Meet the Mind', which delves into the world of
            art through the lens of various visual artists.
          </p>
          <span className="flex text-lg mt-10 mx-auto lg:mx-0">
            {" "}
            <span>Youtube</span>
